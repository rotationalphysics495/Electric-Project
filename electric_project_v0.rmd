...
# Task 3: Who are the top 5 consumers of each energy source?
```{r}
...
# Task 5: Are there any common threads in the data that indicate a transition point between renewable energy resources and fossil fuels? 
```{r}
...
# Task 7: Predicted the energy consumption for the top 10 energy consumers for the next 10 years? How do the energy sources change?
```{r}

```

# Task 8: Which countries have similar energy consumption habits? Use unsupervised learning to segment the countries into 3 groups.
```{r}
